...
CREATE TABLE DonThuoc (
    ...
    CONSTRAINT CHK_DonThuoc_TrangThai CHECK (TrangThai IN (N'Chờ cấp thuốc', N'Đã cấp thuốc', N'Hủy', N'Đã kê đơn'))
);
...
-- 16. Bảng Chỉ Số Sinh Tồn (Vital Signs)
...
-- 17. Bảng Hồ Sơ DICOM (Hình ảnh Y tế)
